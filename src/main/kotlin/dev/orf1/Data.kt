...
@kotlinx.serialization.Serializable
internal data class ConnectRequest(val email: String, val token: String)
...
@kotlinx.serialization.Serializable
internal data class ConnectResponse(val path: String)

@kotlinx.serialization.Serializable
internal data class SocketAuthPacket(val email: String, val token: String)
